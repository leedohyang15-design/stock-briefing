...
- **발송 채널:** 이메일 (SMTP / Gmail) — 선택적으로 **카카오톡 '나에게 보내기'** 병행 (무료)
...
- **GitHub Actions cron 은 러너 부하로 수 분~수십 분 지연될 수 있습니다.** 정시 도착이
  중요하면 실행 시각을 조금 앞당기거나(`50 23 * * 0-4`) 유료 스케줄러를 고려하세요.
